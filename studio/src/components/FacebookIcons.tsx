...
export const HeartIcon = () => (
  <svg fill="none" viewBox="0 0 30 30" className="nl1">
    <path d="M15 27c6.627 0 12-5.373 12-12S21.627 3 15 3 3 8.373 3 15s5.373 12 12 12z" fill="#FF4F67"></path>
    <path fillRule="evenodd" clipRule="evenodd" d="M30 15c0 8.284-6.716 15-15 15-8.284 0-15-6.716-15-15C0 6.716 6.716 0 15 0c8.284 0 15 6.716 15 15zm-3 0c0 6.627-5.373 12-12 12S3 21.627 3 15 8.373 3 15 3s12 5.373 12 12z" fill="#fff"></path>
