                ...
                .child(
                  S.documentTypeList('tag')
                    ...
                    .child((tagId: string) =>
                      S.documentList()
                        .title('Posts')
                        .filter('_type == "post" && $tagId in settings.tags[]._ref')
                        .params({tagId})
                    )
                ),
              S.listItem()
                ...
                .child(
                  S.documentTypeList('author')
                    ...
                    .child((authorId: string) =>
                      S.documentList()
                        .title('Posts')
                        .filter('_type == "post" && $authorId in settings.authors[]._ref')
                        .params({authorId})
                    )
                ),
            ])
                ...
                .child(
                  S.documentTypeList('tag')
                    ...
                    .child((tagId: string) =>
                      S.documentList()
                        .title('Pages')
                        .filter('_type == "page" && $tagId in settings.tags[]._ref')
                        .params({tagId})
                    )
                ),
              S.listItem()
                ...
                .child(
                  S.documentTypeList('author')
                    ...
                    .child((authorId: string) =>
                      S.documentList()
                        .title('Pages')
                        .filter('_type == "page" && $authorId in settings.authors[]._ref')
                        .params({authorId})
                    )
                ),
            ])
